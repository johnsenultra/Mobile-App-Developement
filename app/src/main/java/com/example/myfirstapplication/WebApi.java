...
public class WebApi extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            dbStudent.StudentDeleteAll();
            dbStudent.SchoolYearDeleteAll();
            dbStudent.GradeDeleteAll();
            ...
            dbStudent.StudentAdd(stud_info);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                dbStudent.SchoolYearAdd(sy_list);
            }
